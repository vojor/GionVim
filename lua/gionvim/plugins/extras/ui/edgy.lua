return {
    {
        ...
        opts = function()
            ...
            if GionVim.has("neo-tree.nvim") then
                local pos = {
                    filesystem = "left",
                    buffers = "top",
                    git_status = "right",
                ...
                local sources = GionVim.opts("neo-tree.nvim").sources or {}
                for i, v in ipairs(sources) do
                    table.insert(opts.left, i, {
                        ...
                        open = function()
                            vim.cmd(
                                ("Neotree show position=%s %s dir=%s"):format(pos[v] or "bottom", v, GionVim.root())
                            )
                        end,
                    })
                end
